        ...
        <div class="row">
            <div class="col-md-12">
                <ul class="nav nav-pills flex-column flex-md-row mb-3">
                    <li class="nav-item ">
                        <a class="nav-link active" href="{{ route('staff.security') }}"><i class="bx bx-user me-1"></i>
                            Account</a>
                    </li>
                    <li class="nav-item "><a class="nav-link" href="{{ route('staff.security') }}"><i
                ...
                <div class="card mb-4">
                    ...
                    <!-- Account -->
                    <form id="formAccountSettings" method="POST" action="{{ route('staff.profile.update') }}"
