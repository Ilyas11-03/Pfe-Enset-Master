...
@section('content')
    <div class="content-wrapper">
        <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="card">
                <h5 class="card-header">Add Gym Plan</h5>
                <div class="card-body">
                    <form action="{{ route('main_admin.gym-plans.store') }}" method="POST">
                        @csrf
                        <div class="row">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function calculateTotalAmount() {
                ...
                if (plan && duration) {
                    ...
                    const totalAmount = plan.price * duration * (1 - discount / 100);
            ...
            calculateEndDate(); // Initialize end date on page load
            calculateTotalAmount(); // Initialize total amount on page load
        });
    </script>
@endsection
