                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <p class="form-control">{{ $gymPlan->auto_renew }}</p>
                        </div>
                        <div class="mb-3 col-md-6">
                        ...
                        <div class="mb-3 col-md-12">
                            ...
                            <textarea class="form-control">{{ $gymPlan->notes }}</textarea>
                        </div>
                    </div>
                    <a href="{{ route('main_admin.gym-plans.edit', $gymPlan->id) }}" class="btn btn-primary">Edit</a>
                </div>
            </div>
        </div>
    </div>
