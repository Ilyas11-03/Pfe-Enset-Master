            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card mb-4">
                        ...
                        <form action="{{ route('main_admin.users.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body">
                                <div class="d-flex align-items-start align-items-sm-center gap-4">
                                    <img src="/assets/img/avatars/profile.png" alt="Default Gym"
                                ...
                                <div class="row">
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <select class="form-control @error('gym_id') is-invalid @enderror" id="gym_id"
                                            ...
                                            @foreach ($gyms as $gym)
                                                <option value="{{ $gym->id }}"
                                                    {{ old('gym_id') == $gym->id ? 'selected' : '' }}>{{ $gym->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                        @error('gym_id')
                                    ...
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <select class="form-control @error('role') is-invalid @enderror" id="role"
                                            name="role" required>
                                            <option value="gym_admin" {{ old('role') == 'gym_admin' ? 'selected' : '' }}>
                                                Gym
                                                Admin
                                            </option>
