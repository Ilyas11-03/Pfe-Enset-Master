    ...
    <div class="content-wrapper">
        <div class="container-xxl flex-grow-1 container-p-y">
            <div class="col-12 d-flex justify-content-between align-items-center">
                <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Gyms /</span> Add Gym</h4>
            </div>
            <div class="card p-3">
                <form action="{{ route('main_admin.gyms.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        <div class="d-flex align-items-start align-items-sm-center gap-4">
                            <img src="{{ asset('/assets/img/default.png') }}" alt="Default Gym"
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control @error('operating_hours') is-invalid @enderror"
                                id="operating_hours" name="operating_hours" value="{{ old('operating_hours') }}" required>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function calculateExpiresAt() {
        ...
        if (startsAt && !isNaN(duration)) {
            const expiresAt = new Date(startsAt.setMonth(startsAt.getMonth() + duration));
            expiresAtInput.value = expiresAt.toISOString().split('T')[0];
        }
    }

    startsAtInput.addEventListener('change', calculateExpiresAt);
    durationInput.addEventListener('change', calculateExpiresAt);
});
</script>
@endsection --}}
