    ...
    <div class="content-wrapper">
        <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="col-12 d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route(request()->segment(1) . '.payments.create') }}" class="btn btn-primary">Add Payment</a>
                @if (session('success'))
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="ms-2">
                                                    <a href="{{ route(request()->segment(1) . '.members.show', encrypt($payment->member->id)) }}"
                                        ...
                                        <td>
                                            <div class="d-inline-block text-nowrap">
                                                ...
                                                <!-- Delete Button -->
                                                <form
                                                    action="{{ route(request()->segment(1) . '.payments.destroy', encrypt($payment->id)) }}"
                                                ...
                                                <div class="dropdown d-inline">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item"
                                                            href="{{ route(request()->segment(1) . '.payments.show', encrypt($payment->id)) }}">
