    ...
    <div class="content-wrapper">
        <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('gym_admin.payments.store') }}" method="POST">
                        @csrf
                        <div class="row">
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <select class="form-control @error('sport_id') is-invalid @enderror" id="sport_id"
                                    ...
                                    @foreach ($sports as $sport)
                                        <option value="{{ encrypt($sport->id) }}">{{ $sport->name }}</option>
                                    @endforeach
                                </select>
                                @error('sport_id')
                                    <div class="invalid-feedback">{{ $message }}</div>
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input type="int" class="form-control @error('total_amount') is-invalid @enderror"
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input type="text" class="form-control @error('due_amount') is-invalid @enderror"
                                    id="due_amount" name="due_amount" value="{{ old('due_amount') }}" readonly>
                                @error('due_amount')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            startDateInput.addEventListener('change', function() {
                ...
                const duration = parseInt(membershipSelect.options[membershipSelect.selectedIndex].getAttribute('data-duration'), 10);
            ...
            // Event listener for amount paid change
