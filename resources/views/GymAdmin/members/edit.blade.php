            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card mb-4">
                        ...
                        <form action="{{ route('gym_admin.members.update', Crypt::encrypt($member->id)) }}" method="POST"
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <input type="text" class="form-control @error('name') is-invalid @enderror"
                                            id="name" name="name" value="{{ $member->name }}" required>
                                        @error('name')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <input type="text" class="form-control @error('phone') is-invalid @enderror"
                                            id="phone" name="phone" value="{{ $member->phone }}" required>
                                        @error('phone')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <input type="text" class="form-control @error('address') is-invalid @enderror"
                                            id="address" name="address" value="{{ $member->address }}" required>
                                        @error('address')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="mt-2">
                                    ...
                                    <a href="{{ route('gym_admin.members.index') }}" class="btn btn-outline-secondary">Back</a>
                                </div>
                            </div>
                        </form>
                    </div>
