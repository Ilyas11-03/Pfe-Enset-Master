...
class MemberController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('GymAdmin.members.index', compact(
            'members',
            'totalMembers',
            'activeMembers',
            'inactiveMembers',
    ...
    {
        return view('GymAdmin.members.create');
    }
    ...
    public function store(MemberRequest $request)
    {
        ...
        if ($currentPlan && $currentPlan->plan && $currentPlan->plan->member_limit) {
            ...
            if ($currentMemberCount >= $memberLimit) {
                return redirect()->route('gym_admin.members.index')->with('error', 'Member limit exceeded for your current plan.');
            }
        }
        ...
        return redirect()->route('gym_admin.members.index')->with('success', 'Member added successfully');
    }
    ...
    public function update(MemberRequest $request, string $id)
    {
        ...
        return redirect()->route('gym_admin.members.index')->with('success', 'Member updated successfully');
    }
