...
class AttendanceController extends Controller
{
    public function index(Request $request)
    {
        ...
        $averageDuration = abs($attendances->whereNotNull('duration')->avg('duration'));
        ...
        return view('GymAdmin.attendance.index', compact(
            'attendances',
            'members',
            'totalAttendances',
            'uniqueMembers',
    ...
    public function checkOut(Request $request, $id)
    {
        ...
        if ($attendance->is_checked_in) {
            ...
            $duration = abs(intval($checkOutTime->diffInMinutes($attendance->check_in, false)));
