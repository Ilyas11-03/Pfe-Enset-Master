...
class PaymentController extends Controller
{
    ...
    public function store(PaymentRequest $request)
    {
        ...
        return redirect()->route('gym_admin.payments.index')->with('success', 'Payment added successfully');
    }
    ...
    public function update(PaymentRequest $request, $id)
    {
        ...
        return redirect()->route('gym_admin.payments.index')->with('success', 'Payment updated successfully');
    }
