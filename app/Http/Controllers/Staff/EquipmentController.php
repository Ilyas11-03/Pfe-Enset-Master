...
class EquipmentController extends Controller
{
    ...
    public function store(EquipmentRequest $request)
    {
        ...
        return redirect()->route('staff.equipment.index')->with('success', 'Equipment added successfully');
    }
    ...
    public function update(EquipmentRequest $request, $id)
    {
        ...
        return redirect()->route('staff.equipment.index')->with('success', 'Equipment updated successfully');
    }
